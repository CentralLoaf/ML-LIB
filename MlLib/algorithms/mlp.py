...
# ------------------------
    ...
    def train(self, trainx: np.ndarray, trainy: np.ndarray, testx: np.ndarray, testy: np.ndarray, batch_size: int, epochs: int, optimizer: object) -> None:
        ...
        Args:
            ...
            lr (float): The portion of the gradient taken into account for each sample
...
# ------------------------  
    ...
    def cost(self, testx: np.ndarray, testy: np.ndarray):
        """
        Evaluates the cost of a network based on testing data

        Args:
            testx (array): The inputs for the network
            testy (array): The outputs for the network
        """
